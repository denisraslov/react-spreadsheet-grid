...
var SpreadsheetGrid = function (_React$PureComponent) {
    ...
    _createClass(SpreadsheetGrid, [{
        ...
        value: function getCellClassName(column, row, x, y) {
            return 'SpreadsheetGrid__cell' + ((0, _lodash8.default)(this.state.activeCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_active' : '') + ((0, _lodash8.default)(this.state.focusedCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_focused' : '') + (this.props.disabledCellChecker && this.props.disabledCellChecker(row, column.id) ? ' SpreadsheetGrid__cell_disabled' : '');
        }
    }, {
