...
var _scrollDummy = __webpack_require__(29);
...
var SpreadsheetTableScrollWrapper = function (_React$PureComponent) {
    ...
    _createClass(SpreadsheetTableScrollWrapper, [{
        ...
        value: function scrollCalculations() {
            ...
            var first = Math.floor(scrollTop / this.props.cellHeight) - 1 < 0 ? 0 : Math.floor(scrollTop / this.props.cellHeight) - 1;

            var visibleHeight = this.scrollWrapperElement.parentNode.offsetHeight;

            var last = Math.ceil((scrollTop + visibleHeight) / this.props.cellHeight);

            var position = first * 49 + 'px';
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(5),p=__webpack_require__(10);__webpack_require__(2);var r=__webpack_require__(3);
...
var _keymap = __webpack_require__(23);
...
var SpreadsheetTable = function (_React$PureComponent) {
    ...
    function SpreadsheetTable(props) {
        ...
        if (_this.props.isFirstCellFocused) {
            _this.state.activeCell = { x: 0, y: 0 };
            _this.state.focusedCell = { x: 0, y: 0 };
    ...
    _createClass(SpreadsheetTable, [{
        ...
        value: function renderBody() {
            ...
            var rows = [].concat(_lodash2.default.slice(this.props.rows, this.props.first, this.props.last));
            var columns = this.props.columns;
            var body = void 0;
...
var propTypes = exports.propTypes = {
    ...
    isFirstCellFocused: _propTypes2.default.bool,
...
var SpreadsheetRow = function (_React$PureComponent) {
    _inherits(SpreadsheetRow, _React$PureComponent);
...
var SpreadsheetCell = function (_React$PureComponent) {
    _inherits(SpreadsheetCell, _React$PureComponent);
...
var SpreadsheetTableScrollDummy = function (_React$PureComponent) {
    _inherits(SpreadsheetTableScrollDummy, _React$PureComponent);
