...
var SpreadsheetGridScrollWrapper = function (_React$PureComponent) {
    ...
    _createClass(SpreadsheetGridScrollWrapper, [{
        ...
        value: function freezeTable() {
            ...
            var widthValues = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            ...
            if (table) {
                ...
                var preparedWidthValues = {};
                var sumOfWidth = 0;

                Object.keys(widthValues).forEach(function (id) {
                    sumOfWidth += widthValues[id];
                });

                if (sumOfWidth > 100) {
                    console.error('react-spreadsheet-grid ERROR: The sum of column width values in ' + 'the "widthValues" property is more then 100 percents! ' + 'The values are not being used in this condition!');
                    widthValues = {};
                }
        ...
        value: function processColumnResize(e, nextCell) {
            ...
            if (this.resizingCell) {
                var widthValues = Object.assign({}, this.state.widthValues);
                ...
                if (direction === 'toRight') {
                    ...
                    if (this.resizingCell.offsetWidth + diff > 100 && sibling.offsetWidth - diff > 100) {
                        ...
                        var prevValue1 = widthValues[columns[this.resizingCell.dataset.index].id];
                    ...
                    if (sibling.offsetWidth - _diff > 100 && this.nextResizingCell.offsetWidth + _diff > 100) {
                        ...
                        var _prevValue = widthValues[columns[sibling.dataset.index].id];
                        var _newValue = (parseInt(sibling.offsetWidth, 10) - _diff) * 100 / tableWidth;

                        widthValues[columns[sibling.dataset.index].id] = _newValue;
                        widthValues[columns[this.nextResizingCell.dataset.index].id] -= _newValue - _prevValue;
        ...
        value: function scrollCalculations() {
            ...
            var first = Math.max(0, Math.floor(scrollTop / this.props.cellHeight) - RESERVE_ROWS_COUNT);
        ...
        value: function renderHeader() {
            ...
            var columns = this.props.columns;
            var widthValues = this.state.widthValues;
                    ...
                    return _react2.default.createElement(
                        'div',
                        {
                            ...
                            style: {
                                ...
                                width: widthValues ? widthValues[columns[i].id] + '%' : 'auto'
                            }
                        },
                        typeof column.title === 'string' ? column.title : column.title(),
                        _this5.props.columnsResize && _this5.renderResizer()
                    );
                })
            );
        }
...
var SpreadsheetGrid = function (_React$PureComponent) {
    ...
    _createClass(SpreadsheetGrid, [{
        ...
        value: function getCellClassName(column, row, x, y) {
            return 'SpreadsheetGrid__cell' + ((0, _lodash8.default)(this.state.activeCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_active' : '') + ((0, _lodash8.default)(this.state.focusedCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_focused' : '') + (this.props.checkDisabledCell && this.props.checkDisabledCell(row, column.id) ? ' SpreadsheetGrid__cell_disabled' : '');
        }
    }, {
            ...
            if (rows.length) {
                body = rows.map(function (row) {
                    return _react2.default.createElement(_row2.default, {
                        ...
                        widthValues: _this3.props.widthValues
                    });
                });
            } else {
...
var propTypes = exports.propTypes = {
    ...
    blurFocus: _propTypes2.default.bool,
    ...
    widthValues: _propTypes2.default.object
};
...
var SpreadsheetRow = function (_React$Component) {
    ...
    _createClass(SpreadsheetRow, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
            ...
            return this.props.x !== nextProps.x || currentActiveCell && currentActiveCell.x === this.props.x || nextActiveCell && nextActiveCell.x === this.props.x || this.props.disabledCells !== nextProps.disabledCells || this.props.widthValues !== nextProps.widthValues;
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var _props = this.props,
                ...
                widthValues = _props.widthValues;
