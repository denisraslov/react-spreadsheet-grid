...
var _scrollWrapper = __webpack_require__(15);
...
var _scrollDummy = __webpack_require__(30);
...
var SpreadsheetTableScrollWrapper = function (_React$PureComponent) {
    _inherits(SpreadsheetTableScrollWrapper, _React$PureComponent);

    function SpreadsheetTableScrollWrapper(props) {
        _classCallCheck(this, SpreadsheetTableScrollWrapper);

        var _this = _possibleConstructorReturn(this, (SpreadsheetTableScrollWrapper.__proto__ || Object.getPrototypeOf(SpreadsheetTableScrollWrapper)).call(this, props));
    ...
    _createClass(SpreadsheetTableScrollWrapper, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            window.addEventListener('resize', this.onResize, false);

            var visibleHeight = this.scrollWrapperElement.parentNode.offsetHeight;
            var last = Math.floor(visibleHeight / this.props.cellHeight);
        ...
        value: function scrollCalculations() {
            var scrollTop = this.scrollWrapperElement.scrollTop;
            var first = Math.max(0, Math.floor(scrollTop / this.props.cellHeight) - 1);
            var visibleHeight = this.scrollWrapperElement.parentNode.offsetHeight;

            var last = Math.ceil((scrollTop + visibleHeight) / this.props.cellHeight);
            ...
            return _react2.default.createElement(
                'div',
                {
                    ...
                    ref: function ref(node) {
                        return _this2.scrollWrapperElement = node;
                    }
                },
    ...
    return SpreadsheetTableScrollWrapper;
}(_react2.default.PureComponent);

SpreadsheetTableScrollWrapper.propTypes = _table.propTypes;
...
exports.default = SpreadsheetTableScrollWrapper;
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(7),p=__webpack_require__(10);__webpack_require__(2);var r=__webpack_require__(3);
...
var _keymap = __webpack_require__(24);
...
var RESERVE_ROWS_COUNT = 5;

var SpreadsheetTable = function (_React$PureComponent) {
    _inherits(SpreadsheetTable, _React$PureComponent);

    function SpreadsheetTable(props) {
        _classCallCheck(this, SpreadsheetTable);

        var _this = _possibleConstructorReturn(this, (SpreadsheetTable.__proto__ || Object.getPrototypeOf(SpreadsheetTable)).call(this, props));
        ...
        _this.state = {
            disabledCells: _this.getDisabledCells(_this.props.rows, _this.props.checkDisabledCell)
        };
    ...
    _createClass(SpreadsheetTable, [{
        ...
        value: function freezeTable() {
            ...
            cells.forEach(function (cell) {
                if (_this4.widthValues[cell.cellIndex]) {
                    // если есть сохранённое значение, подстраиваем его под новую ширину таблицы
                    // в процентном соотношении
                    cell.style.width = Math.round(_this4.widthValues[cell.cellIndex] * table.offsetWidth / _this4.widthValues.tableWidth) + 'px';
                } else {
        ...
        value: function startColumnResize(e) {
            ...
            this.currentTh.startOffset = document.body.offsetWidth - this.currentTh.offsetWidth - e.pageX;
        }
    }, {
        key: 'processColumnResize',
        value: function processColumnResize(e, nextTh) {
            ...
            if (this.th) {
                ...
                if (direction === 'toRight') {
                    var diff = this.th.startOffset + e.pageX - parseInt(this.th.style.width, 10);

                    if (this.currentCoords) {
                        sibling = nextTh || this.th.nextSibling;
                    }

                    if (parseInt(this.th.style.width, 10) + diff > 100 && parseInt(sibling.style.width, 10) - diff > 100) {
                    ...
                    var _diff = document.body.offsetWidth - e.pageX - this.currentTh.startOffset - this.currentTh.offsetWidth;

                    if (parseInt(sibling.style.width, 10) - _diff > 100 && parseInt(this.currentTh.style.width, 10) + _diff > 100) {
                        sibling.style.width = parseInt(sibling.style.width, 10) - _diff + 'px';
                        this.currentTh.style.width = parseInt(this.currentTh.style.width, 10) + _diff + 'px';
                        ...
                        if (nextTh) {
                            _cell = nextTh.previousSibling;
                        } else {
                            _cell = this.th.previousSibling;
                        }
        ...
        value: function getDisabledCells(rows, checkDisabledCell) {
            var _this5 = this;
        ...
        value: function componentWillReceiveProps(newProps) {
            ...
            if (this.props.rows !== newProps.rows && newProps.checkDisabledCell) {
                var disabledCells = this.getDisabledCells(newProps.rows, newProps.checkDisabledCell);
                var newState = {
                    disabledCells: disabledCells
                };

                if (_lodash2.default.find(disabledCells, this.state.activeCell)) {
                    newState.activeCell = null;
                }
                if (_lodash2.default.find(disabledCells, this.state.focusedCell)) {
            ...
            if (!e.skipExcelGlobalKeyDown) {
                ...
                if (this.state.activeCell) {
                    var _moveRight = function _moveRight(_ref) {
                        ...
                        if (_lodash2.default.find(block.state.disabledCells, newActiveCell)) {
        ...
        value: function onCellClick(x, y, row, columnId, e) {
            if (!_lodash2.default.find(this.state.disabledCells, { x: x, y: y })) {
                if (!e.skipCellClick && !_lodash2.default.isEqual(this.state.focusedCell, { x: x, y: y })) {
                    this.setState({
        ...
        value: function getCellClassName(column, row, x, y) {
            return (0, _classnames2.default)('SpreadsheetTable__cell', _lodash2.default.isEqual(this.state.activeCell, { x: x, y: y }) && 'SpreadsheetTable__cell_active', _lodash2.default.isEqual(this.state.focusedCell, { x: x, y: y }) && 'SpreadsheetTable__cell_focused', this.props.checkDisabledCell && this.props.checkDisabledCell(row, column.id) && 'SpreadsheetTable__cell_disabled');
        }
    }, {
                ...
                _react2.default.createElement(
                    ...
                    columns.map(function (column, i) {
                        return _react2.default.createElement(
                            ...
                            _this6.props.columnsResize && _this6.renderResizer()
                        );
                    })
                )
            );
        ...
        value: function renderBody() {
            ...
            var rows = [].concat(_lodash2.default.slice(this.props.rows, Math.max(0, this.props.first - RESERVE_ROWS_COUNT), Math.min(this.props.rows.length - 1, this.props.last + RESERVE_ROWS_COUNT)));
            var columns = this.props.columns;
            var body = void 0;
            ...
            if (rows.length) {
                body = rows.map(function (row) {
                    return _react2.default.createElement(_row2.default, {
                        x: _lodash2.default.findIndex(_this7.props.rows, row),
                        key: _this7.props.getRowKey(row),
                        columns: columns,
                        row: row,
                        getCellClassName: _this7.getCellClassName,
                        onCellClick: _this7.onCellClick,
                        onCellDoubleClick: _this7.onCellDoubleClick,
                        activeCell: _this7.state.activeCell,
                        focusedCell: _this7.state.focusedCell,
                        disabledCells: _this7.state.disabledCells,
                        height: _this7.props.cellHeight
                    });
                });
            } else {
                body = _react2.default.createElement(
                    'tr',
                    { className: 'SpreadsheetTable__placeholder' },
                    _react2.default.createElement(
                        'td',
            ...
            return _react2.default.createElement(
                'table',
                {
                    ...
                    ref: function ref(tableElement) {
                        _this8.tableElement = tableElement;
                    }
                },
                this.renderHeader(),
                _react2.default.createElement(
...
var propTypes = exports.propTypes = {
    columns: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        ...
        title: _propTypes2.default.func.isRequired,
    ...
    checkDisabledCell: _propTypes2.default.func,
    ...
    // resize
    columnsResize: _propTypes2.default.bool,
    onColumnResize: _propTypes2.default.func,
    columnsWidth: _propTypes2.default.object
};

SpreadsheetTable.propTypes = propTypes;

exports.default = SpreadsheetTable;
...
var SpreadsheetRow = function (_React$Component) {
    ...
    _createClass(SpreadsheetRow, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
            ...
            return this.props.x !== nextProps.x || currentActiveCell && currentActiveCell.x === this.props.x || nextActiveCell && nextActiveCell.x === this.props.x || this.props.disabledCells !== nextProps.disabledCells;
        }
    }, {
        key: 'render',
        value: function render() {
                ...
                columns.map(function (column, y) {
                    ...
                    return _react2.default.createElement(
                        _cell2.default,
                        {
                            ...
                            onClick: !disabled && onCellClick.bind(_this2, x, y, row, column.id),
                            onDoubleClick: !disabled && onCellDoubleClick.bind(_this2, x, y),
                            isActive: _lodash2.default.isEqual(activeCell, coords),
                            isFocused: _lodash2.default.isEqual(focusedCell, coords),
                            disabledCells: _this2.props.disabledCells
                        },
                        column.value(row, {
                            active: _lodash2.default.isEqual(activeCell, coords),
                            focus: _lodash2.default.isEqual(focusedCell, coords),
                            disabled: disabled
                        })
                    );
                })
...
SpreadsheetRow.propTypes = {
    ...
    disabledCells: _propTypes2.default.bool,
...
var SpreadsheetCell = function (_React$Component) {
    ...
    _createClass(SpreadsheetCell, [{
        key: 'shouldComponentUpdate',
        value: function shouldComponentUpdate(nextProps) {
            return this.props.isActive !== nextProps.isActive || this.props.isFocused !== nextProps.isFocused || this.props.x !== nextProps.x || this.props.disabledCells !== nextProps.disabledCells;
        }
    }, {
        key: 'render',
        value: function render() {
...
var SpreadsheetTableScrollDummy = function (_React$Component) {
    _inherits(SpreadsheetTableScrollDummy, _React$Component);

    function SpreadsheetTableScrollDummy(props) {
        _classCallCheck(this, SpreadsheetTableScrollDummy);

        var _this = _possibleConstructorReturn(this, (SpreadsheetTableScrollDummy.__proto__ || Object.getPrototypeOf(SpreadsheetTableScrollDummy)).call(this, props));
    ...
    _createClass(SpreadsheetTableScrollDummy, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(newProps) {
    ...
    return SpreadsheetTableScrollDummy;
}(_react2.default.Component);
...
exports.default = SpreadsheetTableScrollDummy;
...
// module
exports.push([module.i, ".SpreadsheetTableScrollDummy {\n    position: relative;\n    min-width: 100%;\n}", ""]);
...
// module
exports.push([module.i, ".SpreadsheetTableScrollWrapper {\n    position: relative;\n    height: 100%;\n    overflow-x: hidden;\n    overflow-y: auto;\n    -webkit-transition: height 0.3s;\n    transition: height 0.3s;\n}", ""]);
...
var SpreadsheetTableInput = function (_React$PureComponent) {
    _inherits(SpreadsheetTableInput, _React$PureComponent);

    function SpreadsheetTableInput(props) {
        _classCallCheck(this, SpreadsheetTableInput);

        var _this = _possibleConstructorReturn(this, (SpreadsheetTableInput.__proto__ || Object.getPrototypeOf(SpreadsheetTableInput)).call(this, props));
    ...
    _createClass(SpreadsheetTableInput, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
...
exports.default = SpreadsheetTableInput;
...
// module
exports.push([module.i, ".SpreadsheetTable__Input {\n    height: 100%;\n    width: 100%;\n    padding: 0 10px;\n    border: none;\n    border-radius: 0;\n    font-size: 13px;\n    line-height: 15px;\n}", ""]);
