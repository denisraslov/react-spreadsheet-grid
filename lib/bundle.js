...
var SpreadsheetGrid = function (_React$PureComponent) {
    ...
    function SpreadsheetGrid(props) {
        ...
        _this.state = {
            disabledCells: _this.getDisabledCells(_this.props.rows, _this.props.disableCellChecker)
        };
    ...
    _createClass(SpreadsheetGrid, [{
        ...
        value: function componentWillReceiveProps(newProps) {
            if (this.props.rows !== newProps.rows && newProps.disableCellChecker) {
                var disabledCells = this.getDisabledCells(newProps.rows, newProps.disableCellChecker);
                var newState = {
        ...
        value: function getDisabledCells(rows, disableCellChecker) {
            var _this2 = this;
        ...
        value: function getCellClassName(column, row, x, y) {
            return 'SpreadsheetGrid__cell' + ((0, _lodash8.default)(this.state.activeCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_active' : '') + ((0, _lodash8.default)(this.state.focusedCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_focused' : '') + (this.props.disableCellChecker && this.props.disableCellChecker(row, column.id) ? ' SpreadsheetGrid__cell_disabled' : '');
        }
    }, {
...
var propTypes = exports.propTypes = {
    ...
    disableCellChecker: _propTypes2.default.func,
